...
const Block = ({
  ...
  return (
    <Link
      href={link}
      className={
        "w-full group p-[0.781vw] hover:bg-white transition-colors hover:text-black h-auto rounded-[0.521vw] bg-gray-light flex flex-col"
      }
    >
      <div className="flex flex-row w-full items-center justify-between">
        <span
          className={
            "font-outfit group-hover:text-black text-[1.25vw] text-white font-medium"
          }
        >
          0{index}
        </span>
      ...
      <div className={"mt-[9.115vw] flex flex-col"}>
        ...
        <span
          className={
            "text-[0.833vw] group-hover:text-black uppercase mt-[0.781vw] leading-[110%] font-medium font-outfit text-white"
          }
        >
          {title}
        </span>
        <span
          className={
            "mt-[0.521vw] group-hover:text-black text-white text-[0.833vw] font-helvetica-now "
          }
        >
          {text}
        </span>
