    ...
    >
      <g opacity="0.6">
        <path
          ...
          fill="#FFFCF5"
        />
        <path d="M29 1H36V29H29" stroke="#FFFCF5" stroke-width="2" />
        <path d="M8 1H1V29H8" stroke="#FFFCF5" stroke-width="2" />
      </g>
    </svg>
  );
};
  ...
  return (
    <AnimatePresence initial={false}>
      ...
      >
        ...
        {isOpen && (
          <motion.div
            className={"flex flex-col gap-[0.781vw] mt-[0.521vw] w-full"}
          ...
          >
            <span
              className={
                "text-white text-[0.833vw] font-helvetica-now leading-[120%]"
              }
            >
              {description}
            </span>
