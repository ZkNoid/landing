...
const SocialLink = ({ link, icon }: { link: string; icon: ReactNode }) => {
  return (
    <Link href={link} target="_blank" rel="noreferrer">
      <motion.div
        className={
          "w-[7.187vw] h-[7.187vw] border border-white bg-white rounded-full flex items-center justify-center"
        }
...
export default function Community() {
  return (
    <section className={"mt-[10.417vw] bg-gray-light rounded-[1.563vw]"}>
      <div
        className={
          "px-[10.938vw] pt-[1.406vw] pb-[5.208vw] flex flex-col justify-center items-center"
        }
      >
        <span
          className={
        ...
        <div
          className={"w-[72.917vw] flex flex-row gap-[1.042vw] items-center"}
        >
          <span
            className={
              "font-helvetica-now w-[40%] text-center uppercase text-white text-[1.563vw] leading-[110%] font-medium"
            }
          >
