...
const LandingSection = (props: { title: string; children: ReactNode }) => {
  return (
    <div
      className={`w-full relative flex justify-center px-[10px] md:px-[50px] ${
        debug && "border"
      }`}
    >
...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col">
      ...
      <div
        className={`h-[550px] md:h-[800px] lg:h-[783px] w-full relative flex justify-center ${
          debug && "border"
        }`}
      >
        <Image
          src={"/image/chess.svg"}
          className="hidden lg:block w-full absolute bottom-0 pointer-events-none"
          width={1618}
          height={541}
          alt="Medium"
        ></Image>
        <Image
          src={"/image/cover-image-mobile.svg"}
          className="block lg:hidden w-full absolute bottom-0 pointer-events-none"
          width={1618}
          height={541}
          alt="Medium"
        ></Image>
        <div className="pt-[40px] lg:pt-[173px] mx-3 ">
          <div
            className={`${museoSlab.className} text-mobile-headline-0 lg:text-cover-text-1`}
          >
            WEB3
          </div>
          <div
            className={`${museoSlab.className} text-[30px]/[30px] lg:text-cover-text-2`}
          >
            Gaming platform
          </div>
          <div className="lg:pl-10 pt-2 flex flex-col justify-end md:flex-row font-plexmono text-mobile-main-text lg:text-regular-text">
            ...
            <Link
              className="cursor-pointer text-mobile-link-1 lg:text-headline-3 pt-3 md:pt-0 md:pl-3 flex underline decoration-left-accent underline-offset-[5px] hover:opacity-80 ease-in-out"
              href="https://docs.zknoid.io"
            >
              Open Docs{" "}
              <Image
                src={"/image/docs_arrow.svg"}
                className="ml-1"
                width={16}
                height={16}
                alt="Arrow"
        ...
        <div className="items-center  lg:items-start grid flex-rows-3 lg:grid-cols-3 w-full justify-between pt-16 gap-[20px]">
          <div className="flex items-start">
            ...
            <div className="pl-5 pb-5 font-plexmono text-mobile-main-text lg:text-regular-text">
              ZkNoid provides the united ecosystem for ZK gaming – developers
              can use SDK to be a part of the platform. L2 rollup based on
              protokit network enables gasless sessions, fast transactions
            </div>
          </div>
          <div className="flex items-start">
            ...
            <div className="pl-5 pb-5 font-plexmono text-mobile-main-text lg:text-regular-text">
              ...
              zero-knowledge circuit on the client side, ensuring verifiability
              of the game process while your strategy remains confidential.
            </div>
          </div>
          <div className="flex items-start">
            <Image src={"image/03.svg"} width={96} height={96} alt="03"></Image>
            <div className="pl-5 pb-5 font-plexmono text-mobile-main-text lg:text-regular-text">
              Host fair competitions within your community and reward your most
              engaged fans - with no possibility of cheating
            </div>
          </div>
        </div>
      </LandingSection>
      ...
      <LandingSection title="Benefits for gamers">
        <div className="flex flex-col">
          <div className="md:w-[400px] lg:w-[500px] 2xl:w-[800px] pt-4 lg:pt-10 md:ml-[30%] font-plexmono text-mobile-main-text lg:text-regular-text">
            Elevate your gaming journey and embrace a future where transparency
            and integrity define the ultimate gaming experience
          </div>
          <div
            className={
              "flex lg:grid grid-cols-4 grid-rows-2 flex-col gap-4 lg:gap-0 w-full pt-4"
            }
          >
            <BenefitsForGamersCard
              ...
              title={"Provable"}
              text={
                "Experience true gaming transparency with provable game process correctness"
              }
            />
            <Image
            ...
            <BenefitsForGamersCard
              ...
              text={
                "Showcase your skills and results publicly and earn valuable NFT rewards for your achievements"
              }
            />
            <Image
            ...
            <BenefitsForGamersCard
              ...
              text={
                "Challenge and compete with your friends in a trustworthy environment"
              }
        ...
        <SlidableBlock
          slides={[
            ...
            },
            {
              name: "Randzu",
              description:
                "A tic tac toe like game. Two players take turns placing pieces on the board attempting to create lines of 5 of their own color. Game state is synced and proved using zkapp transactions",
      ...
      <LandingSection title="Backed by">
        <div
          className={
            "flex flex-col lg:flex-row gap-4 justify-start items-center"
          }
        >
          <div className="font-plexmono text-mobile-main-text lg:text-regular-text w-full lg:w-[450px] lg:h-full lg:pt-10">
            Our esteemed list of backers and investors who are trust the
            groundbreaking ZkNoid gaming
          </div>
          <div className="grid grid-rows-2 lg:grid-rows-1 grid-cols-2 lg:grid-cols-3 gap-2 lg:gap-4 w-full lg:p-10 flex-grow">
            <Image
              src={"/image/backed_by/mina_foundation.svg"}
              width={360}
              height={184}
              className="lg:w-full"
              alt="Mina foundation"
            ></Image>
            <Image
              src={"/image/backed_by/o1labs.svg"}
              width={360}
              height={184}
              className="lg:w-full"
              alt="O1js labs"
            ></Image>
            <Image
              src={"/image/backed_by/announced_soon.svg"}
              width={360}
              height={184}
              className="lg:w-full"
              alt="Announced soon"
          ...
          slides={[
            {
              ...
              children: (
                <>
                  <p>
                    Top-1 solidity auditor at{" "}
                    <a
                      href="https://strongholdsec.io/leaderboard"
                      className="text-left-accent"
                    >
                      Mixbytes auditor DAO
                    </a>
                    .
                  </p>
                  <p className={"py-2"}>
                    Core builder of{" "}
                    <a
                      href="https://www.xraise.io/"
                      className="text-left-accent"
                    >
                      xraise.io
                    </a>{" "}
                    project – account abstraction based wallet.
                  </p>
                  <p>
                    Blockchain and full-stack developer. Studied at MSU, applied
            ...
            },
            {
              ...
              children: (
                <>
                  <p>Crypto enthusiast since 2020.</p>{" "}
                  <p>
                    CS MS in MIPT.
                  </p>
                  <p>
                      Experienced solidity developer with two years experience
                      in DEFI projects.
                    </p>
            ...
            },
            {
              ...
              children: (
                <>
                  Ui/Ux & Graphic designer in crypto since 2022 as a member of
                  PowerPool R&D and marketing team{" "}
                  <a
                    href="https://powerpool.finance"
                    className="text-right-accent inline"
                  >
                    powerpool.finance
                  </a>
                </>
          ...
          <div className="flex flex-col lg:flex-row w-full items-center justify-between">
            <div className="font-bold cursor-pointer pb-8 lg:pb-0 flex lg:block flex-row justify-between w-full lg:w-auto">
              <Link
                ...
                className={
                  "hover:opacity-80 ease-in-out cursor-pointer text-logo-text"
                }
              >
                ZkNoid
              </Link>
            ...
            <div className="grid lg:flex grid-rows-2 grid-cols-2 text-base gap-2 lg:gap-8 w-full lg:w-auto text-menu-text">
              ...
              {/*</Link>*/}
              <Link
                className="cursor-pointer text-lg lg:text-xl hover:opacity-80 ease-in-out even:text-right"
        ...
        <div className="flex justify-between flex-col lg:flex-row py-3">
          <div className="gap-5 hidden lg:flex">
            {SOCIALS.map((social) => (
              <Link
                key={social.name}
                className="cursor-pointer text-xl flex items-center justify-center hover:opacity-80 ease-in-out"
                href={social.link}
                target="_blank"
                rel="noopener noreferrer"
              >
